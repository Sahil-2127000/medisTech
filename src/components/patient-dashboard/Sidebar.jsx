...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col px-6 pb-8">
      ...
      <div className="text-[10px] font-black text-gray-400 tracking-widest uppercase mb-3 px-2 mt-4">Navigation Menu</div>
      ...
      <button 
        ...
        className="w-full py-3 px-4 rounded-xl flex items-center gap-3 transition-all text-red-400 hover:bg-red-50 hover:text-red-600 mt-6 group"
      >
        ...
        <span className="font-semibold text-[13px]">Sign Out Securely</span>
      </button>
