...
const CurrentPatient = ({ appointments, onFinishConsultation, onStatusChange }) => {
  ...
  const renderPatientCard = (patient) => {
    ...
    return (
      <div className="bg-white rounded-3xl p-5 shadow-xl shadow-blue-500/5 flex flex-col items-center text-center border border-gray-50 relative overflow-hidden transition-colors duration-300 w-full mb-4 shrink-0 ">
