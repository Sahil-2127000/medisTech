  ...
  return (
    <section id="contact" className="w-full max-w-7xl mx-auto px-8 md:px-16 py-24">
      <div className="bg-blue-500 rounded-[3rem] overflow-hidden shadow-2xl relative flex flex-col md:flex-row">
        ...
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-cyan-400/20 rounded-full blur-3xl translate-y-1/3 -translate-x-1/3"></div>

        {/* Left Side: Contact Form */}
        <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 relative z-10 bg-white md:rounded-r-[3rem]">
          ...
          <form className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="tel" placeholder="+1 (555) 000-0000" className="w-full border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors" />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Email</label>
                <input type="email" placeholder="john@example.com" className="w-full border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors" />
              </div>
            </div>
            ...
            <button type="button" className="w-full bg-slate-900 hover:bg-slate-800 text-white rounded-xl px-4 py-3.5 font-medium transition-colors shadow-lg shadow-slate-900/20">
              Request Appointment
            </button>
          </form>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 relative z-10 flex flex-col justify-center text-white">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-lg">123 Healthway Drive<br/>Your City, State, Zip</p>
              </div>
            </div>
            
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center shrink-0">
                <svg className="w-5 h-5 lg:w-6 lg:h-6 text-green-500" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-lg">care@doctornameclinic.com</p>
              </div>
            </div>
