    ...
    <section className="relative w-full pt-16 pb-24 lg:pt-24 lg:pb-32 flex items-center overflow-hidden mb-12">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-8 md:px-16">
        ...
        <div className="space-y-8 max-w-xl">
          ...
          <div className="pt-2">
            <Link to="/auth" className="inline-block bg-[#30c7bd] hover:bg-[#04cfcf] text-white px-8 py-3.5 rounded-full hover:scale-105 font-medium transition-all shadow-lg shadow-teal-500/30">
              Book Appointment
            </Link>
          </div>
          ...
          <div className="flex items-center gap-8 md:gap-12 pt-8 mt-8 border-t border-white/20">
            ...
            <div>
              <div className="text-4xl font-bold text-white">{displayTreated}+</div>
              <div className="text-sm text-blue-200 mt-1 font-medium">Patients Treated</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#04fdfd]">{displaySatisfaction}%</div>
