...
const LoginForm = ({ onSwitch }) => {
  ...
  const handleForgotResetSubmit = async (e) => {
    ...
    try {
      ...
      const data = await res.json();
      if (res.ok) {
        setForgotMessage({ text: 'Successfully reset! Sign in with your new credentials.', isError: false });
    ...
    return (
      <div className="animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-gray-400 mt-1 font-medium">Follow the secure steps to reset password </p>
        </div>
        ...
        {forgotStep === 'reset' && (
          <form onSubmit={handleForgotResetSubmit} className="space-y-4">
            <div className="space-y-1">
              ...
              <div className="relative">
                <input 
                  ...
                  placeholder="••••••••" 
                  className="w-full border-b border-gray-300 py-2 pr-10 focus:outline-none focus:border-blue-500 text-sm text-gray-800 transition-colors"
                />
                <button 
                  type="button" 
            ...
            <div className="space-y-1">
              <label className="text-xs font-semibold text-blue-500 uppercase tracking-widest">Confirm New Password</label>
              <div className="relative">
                <input 
