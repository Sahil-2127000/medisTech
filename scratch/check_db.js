...
async function checkDB() {
  await mongoose.connect(process.env.MONGO_URL || 'mongodb+srv://nitish:nitish@cluster0.r80v4.mongodb.net/medisTech?retryWrites=true&w=majority&appName=Cluster0');
